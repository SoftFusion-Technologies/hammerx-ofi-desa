 ...
 *
 * Descripción:
 *  Este archivo (FormAltaFamiliarI.jsx) es el componente donde realizamos un formulario para
...
const FormAltaFamiliarI = ({
  ...
  const nuevoFamiliarSchema = Yup.object().shape({
    ...
    >
      <div className={`container-inputs`}>
        ...
        <Formik
          ...
          validationSchema={nuevoFamiliarSchema}
        >
