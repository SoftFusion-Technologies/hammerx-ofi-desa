 ...
 *
 * Descripción:
 *  Este archivo (FormAltaNotaFam.jsx) es el componente donde realizamos un formulario para
...
import FormAltaNota from './FormAltaNota';

const FormAltaNotaFam = ({ isOpen, onClose, user }) => {
