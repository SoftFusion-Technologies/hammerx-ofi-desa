...
const ModalError = ({ isVisible, onClose, textoModal }) => {
  ...
  const mensajePorDefecto =
    'Lamentablemente no se pudo recibir tu información. Por favor, intentá nuevamente y, si el problema persiste, comunicate con nuestro equipo.';
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_18px_45px_rgba(148,163,184,0.35)]">
          ...
          <button
            type="button"
            onClick={onClose}
            className="absolute right-3 top-3 inline-flex h-7 w-7 items-center justify-center rounded-full border border-slate-200 bg-white text-xs font-semibold text-slate-500 hover:text-slate-800 hover:border-slate-300 hover:bg-slate-50 transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
            aria-label="Cerrar"
          >
            ×
          </button>
          ...
          <div className="flex flex-col items-center px-6 pt-7 pb-5 text-center">
            ...
            <div className="relative mb-4 flex flex-col items-center gap-2">
              <div className="relative">
                ...
                <div className="relative flex h-14 w-14 items-center justify-center rounded-full bg-rose-50 border border-rose-200">
                  <span className="flex h-9 w-9 items-center justify-center rounded-full bg-rose-500 text-white text-lg font-semibold shadow-lg">
                    !
                  </span>
                </div>
              </div>
            ...
            <div className="w-full border-t border-slate-200 pt-3 mt-1">
              ...
              <div className="flex items-center justify-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="h-8 w-8 flex items-center justify-center rounded-full bg-slate-50 border border-slate-200 hover:bg-rose-50 hover:border-rose-200 hover:scale-105 transition"
            ...
            <button
              type="button"
              onClick={onClose}
              className="mt-4 inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-rose-500 via-rose-500 to-rose-400 px-5 py-2 text-xs font-semibold text-white shadow-[0_8px_18px_rgba(244,63,94,0.35)] hover:shadow-[0_10px_22px_rgba(244,63,94,0.45)] hover:-translate-y-[1px] transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
            >
              Entendido
            </button>
          </div>
