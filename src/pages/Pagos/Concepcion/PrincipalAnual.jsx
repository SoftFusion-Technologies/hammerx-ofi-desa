...
const handleTransferenciaClick = () => {
  navigate('/pagos/concepcion/anual/transferencia', { replace: false });
};

const handleEfectivoClick = () => {
  navigate('/pagos/concepcion/anual/efectivo', { replace: false });
};

const handleDebitoClick = () => {
  navigate('/pagos/concepcion/anual/tarjeta-debito', { replace: false });
};
  ...
  const handleAnualClick = () => {
    navigate('/pagos/concepcion/anual/cuotas', { state: { cuotas1: true, cuotas3: true, cuotas6: true, cuotas12: true } }); //cantidad de cuotas habilitadas
  };
  return (
