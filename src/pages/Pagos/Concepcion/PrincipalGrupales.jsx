...
const handleTransferenciaClick = () => {
  navigate('/pagos/concepcion/grupales/transferencia', { replace: false });
};

const handleEfectivoClick = () => {
  navigate('/pagos/concepcion/grupales/efectivo', { replace: false });
};

const handleDebitoClick = () => {
  navigate('/pagos/concepcion/grupales/tarjeta-debito', { replace: false });
};
