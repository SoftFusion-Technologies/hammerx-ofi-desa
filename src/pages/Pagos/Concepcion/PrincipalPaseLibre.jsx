...
const handleTransferenciaClick = () => {
  navigate('/pagos/concepcion/paselibre/transferencia', { replace: false });
};

const handleEfectivoClick = () => {
  navigate('/pagos/concepcion/paselibre/efectivo', { replace: false });
};

const handleDebitoClick = () => {
  navigate('/pagos/concepcion/paselibre/tarjeta-debito', { replace: false });
};
    ...
    <div className="content_v2 back_v2">
      ...
      <div className="plan-info_v2">
        <p className="plan-text_v2">
          Estás por abonar $24.500 de : Pase Libre (sede Concepción)
        </p>
      </div>
