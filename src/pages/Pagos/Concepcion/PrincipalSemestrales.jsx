...
const handleTransferenciaClick = () => {
  navigate('/pagos/concepcion/semestral/transferencia', { replace: false });
};

const handleEfectivoClick = () => {
  navigate('/pagos/concepcion/semestral/efectivo', { replace: false });
};

const handleDebitoClick = () => {
  navigate('/pagos/concepcion/semestral/tarjeta-debito', { replace: false });
};
  ...
  const handleSemestralClick = () => {
    navigate('/pagos/concepcion/semestral/cuotas', { state: { cuotas1: true, cuotas3: true, cuotas6: true, cuotas12: false } }); //cantidad de cuotas habilitadas
  };
  return (
