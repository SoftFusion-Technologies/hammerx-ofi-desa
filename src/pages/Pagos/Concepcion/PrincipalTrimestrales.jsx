...
const handleTransferenciaClick = () => {
  navigate('/pagos/concepcion/trimestral/transferencia', { replace: false });
};

const handleEfectivoClick = () => {
  navigate('/pagos/concepcion/trimestral/efectivo', { replace: false });
};

const handleDebitoClick = () => {
  navigate('/pagos/concepcion/trimestral/tarjeta-debito', { replace: false });
};
  ...
  const handleTrimestralClick = () => {
    navigate('/pagos/concepcion/trimestral/cuotas', { state: { cuotas1: true, cuotas3: true, cuotas6: false, cuotas12: false } }); //cantidad de cuotas habilitadas
  };
  return (
    <div className="content_v2 back_v2">
      ...
      <div className="plan-info_v2">
        <p className="plan-text_v2">
          Estás por abonar tu plan: Trimestral (sede Concepción)
        </p>
      </div>
      
      <div className="payment-info_v2" onClick={handleTrimestralClick}>
