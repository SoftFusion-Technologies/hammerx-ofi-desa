...
const handleTransferenciaClick = () => {
  navigate('/pagos/monteros/paselibre/transferencia', { replace: false });
};

const handleEfectivoClick = () => {
  navigate('/pagos/monteros/paselibre/efectivo', { replace: false });
};

const handleDebitoClick = () => {
  navigate('/pagos/monteros/paselibre/tarjeta-debito', { replace: false });
};
