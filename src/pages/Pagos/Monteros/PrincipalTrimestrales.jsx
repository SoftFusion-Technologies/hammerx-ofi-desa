...
const handleTransferenciaClick = () => {
  navigate('/pagos/monteros/trimestral/transferencia', { replace: false });
};

const handleEfectivoClick = () => {
  navigate('/pagos/monteros/trimestral/efectivo', { replace: false });
};

const handleDebitoClick = () => {
  navigate('/pagos/monteros/trimestral/tarjeta-debito', { replace: false });
};
  ...
  const handleTrimestralClick = () => {
    navigate('/pagos/monteros/trimestral/cuotas', { state: { cuotas1: true, cuotas3: true, cuotas6: false, cuotas12: false } }); //cantidad de cuotas habilitadas
  };
  return (
