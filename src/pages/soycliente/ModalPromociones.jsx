              ...
              <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="p-4 md:p-5 space-y-4">
                  <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400 font-messina">
                    En Hammer contamos con promociones Familiares y promociones amigos referidos.
                  </p>
                  <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400 font-messina">
                    Para conocerlas hace click aca así nos ponemos en contacto y te asesoramos.
                  </p>
                </div>
                {/* Modal footer */}
